        ...
        <div className=" justify-center">
            <center className="mt-24 m-auto">
                ...
                <div className=" tracking-widest mt-4">
                    <span className="text-gray-500 text-6xl block"><span>{status || 404}</span></span>
                    <span className="text-gray-500 text-xl">{error?.message}</span>

                </div>
            </center>
            <center className="mt-6">
               <Link to='/'> <a  className="text-gray-500 font-mono text-xl bg-primary p-3 rounded-md hover:shadow-md">Go back </a></Link>
            </center>
        </div>
    );
};
